...
public class GameService {
    ...
    */
    ...
    // Metoden används för att scheamlägga en övergång från frågefasen (question) till svarsförklaringsfasen (answer) i en spelrunda
    ...
    // Schemalägger antingen nästa runda alternativt avslutar spelet ifall vi har spelet 5 rundor
